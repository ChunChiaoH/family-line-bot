...
- 長期：per-member 人格側寫（口頭禪、在乎的事、安慰人的方式）。用途定調為
  「熟悉但不踰越的傾聽者」——bot 永遠以自己的聲音引用與轉述（「他常說…」「以我對他
  的了解，他大概會…」，推測要標明），**明確不做第一人稱扮演故人**（使用者 2026-07-16
  拍板；第三人稱的理解與同理，如同家人講故人軼事，避開 digital legacy 的身分冒用爭議）。
  互動以被動為主（家人主動問起才接），主動提起僅限對話自然走到時輕接。
